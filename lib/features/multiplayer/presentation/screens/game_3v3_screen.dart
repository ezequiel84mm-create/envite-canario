...
class _Game3v3ScreenState extends State<Game3v3Screen> {
  ...
  void _renunciarMano() {
    _votacionRenuncioActiva = false; // limpiar estado de votacion
    _votosRenuncioPendientes.clear();
  ...
  List<CardModel> _validasDe(int asiento) {
    ...
    return TrickEngine3v3.cartasValidas(
      mano: mano,
          ...
          SafeArea(
            child: Column(
              children: [
                ...
                // Arriba (pos 3): jugador del fondo, centrado.
                _jugadorRival(
                    asiento: _asientoEnPos(3),
                    etiqueta: _nombrePosicion(_asientoEnPos(3)),
                    esCompanero: _esCompaneroPos(3)),
                // Zona central: 2 jugadores a cada lado + cartas jugadas.
                Expanded(
                  child: Row(
  ...
  Widget _zonaCentral() {
    return Stack(
      ...
      children: [
        ...
        // pos 1 = izq-abajo
        Align(alignment: const Alignment(-1.0, 0.55),
